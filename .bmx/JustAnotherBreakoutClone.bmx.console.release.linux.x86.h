#ifndef JUSTANOTHERBREAKOUTCLONE_JUSTANOTHERBREAKOUTCLONE_BMX_CONSOLE_RELEASE_LINUX_X86_H
#define JUSTANOTHERBREAKOUTCLONE_JUSTANOTHERBREAKOUTCLONE_BMX_CONSOLE_RELEASE_LINUX_X86_H

#include <brl.mod/blitz.mod/.bmx/blitz.bmx.release.linux.x86.h>
#include <brl.mod/appstub.mod/.bmx/appstub.bmx.release.linux.x86.h>
#include <brl.mod/audio.mod/.bmx/audio.bmx.release.linux.x86.h>
#include <brl.mod/bank.mod/.bmx/bank.bmx.release.linux.x86.h>
#include <brl.mod/bankstream.mod/.bmx/bankstream.bmx.release.linux.x86.h>
#include <brl.mod/base64.mod/.bmx/base64.bmx.release.linux.x86.h>
#include <brl.mod/basic.mod/.bmx/basic.bmx.release.linux.x86.h>
#include <brl.mod/bmploader.mod/.bmx/bmploader.bmx.release.linux.x86.h>
#include <brl.mod/clipboard.mod/.bmx/clipboard.bmx.release.linux.x86.h>
#include <brl.mod/collections.mod/.bmx/collections.bmx.release.linux.x86.h>
#include <brl.mod/crypto.mod/.bmx/crypto.bmx.release.linux.x86.h>
#include <brl.mod/d3d7max2d.mod/.bmx/d3d7max2d.bmx.release.linux.x86.h>
#include <brl.mod/d3d9max2d.mod/.bmx/d3d9max2d.bmx.release.linux.x86.h>
#include <brl.mod/data.mod/.bmx/data.bmx.release.linux.x86.h>
#include <brl.mod/directsoundaudio.mod/.bmx/directsoundaudio.bmx.release.linux.x86.h>
#include <brl.mod/dxgraphics.mod/.bmx/dxgraphics.bmx.release.linux.x86.h>
#include <brl.mod/event.mod/.bmx/event.bmx.release.linux.x86.h>
#include <brl.mod/eventqueue.mod/.bmx/eventqueue.bmx.release.linux.x86.h>
#include <brl.mod/font.mod/.bmx/font.bmx.release.linux.x86.h>
#include <brl.mod/freeaudioaudio.mod/.bmx/freeaudioaudio.bmx.release.linux.x86.h>
#include <brl.mod/freetypefont.mod/.bmx/freetypefont.bmx.release.linux.x86.h>
#include <brl.mod/glgraphics.mod/.bmx/glgraphics.bmx.release.linux.x86.h>
#include <brl.mod/glmax2d.mod/.bmx/glmax2d.bmx.release.linux.x86.h>
#include <brl.mod/gnet.mod/.bmx/gnet.bmx.release.linux.x86.h>
#include <brl.mod/jpgloader.mod/.bmx/jpgloader.bmx.release.linux.x86.h>
#include <brl.mod/json.mod/.bmx/json.bmx.release.linux.x86.h>
#include <brl.mod/map.mod/.bmx/map.bmx.release.linux.x86.h>
#include <brl.mod/matrix.mod/.bmx/matrix.bmx.release.linux.x86.h>
#include <brl.mod/maxlua.mod/.bmx/maxlua.bmx.release.linux.x86.h>
#include <brl.mod/maxutil.mod/.bmx/maxutil.bmx.release.linux.x86.h>
#include <brl.mod/oggloader.mod/.bmx/oggloader.bmx.release.linux.x86.h>
#include <brl.mod/openalaudio.mod/.bmx/openalaudio.bmx.release.linux.x86.h>
#include <brl.mod/pngloader.mod/.bmx/pngloader.bmx.release.linux.x86.h>
#include <brl.mod/quaternion.mod/.bmx/quaternion.bmx.release.linux.x86.h>
#include <brl.mod/retro.mod/.bmx/retro.bmx.release.linux.x86.h>
#include <brl.mod/tgaloader.mod/.bmx/tgaloader.bmx.release.linux.x86.h>
#include <brl.mod/threadpool.mod/.bmx/threadpool.bmx.release.linux.x86.h>
#include <brl.mod/timer.mod/.bmx/timer.bmx.release.linux.x86.h>
#include <brl.mod/timerdefault.mod/.bmx/timerdefault.bmx.release.linux.x86.h>
#include <brl.mod/volumes.mod/.bmx/volumes.bmx.release.linux.x86.h>
#include <brl.mod/wavloader.mod/.bmx/wavloader.bmx.release.linux.x86.h>
#include <brl.mod/xml.mod/.bmx/xml.bmx.release.linux.x86.h>
#include <pub.mod/freejoy.mod/.bmx/freejoy.bmx.release.linux.x86.h>
#include <pub.mod/freeprocess.mod/.bmx/freeprocess.bmx.release.linux.x86.h>
#include <pub.mod/glad.mod/.bmx/glad.bmx.release.linux.x86.h>
#include <pub.mod/macos.mod/.bmx/macos.bmx.release.linux.x86.h>
#include <pub.mod/nx.mod/.bmx/nx.bmx.release.linux.x86.h>
#include <pub.mod/opengles.mod/.bmx/opengles.bmx.release.linux.x86.h>
#include <pub.mod/vulkan.mod/.bmx/vulkan.bmx.release.linux.x86.h>
#include <pub.mod/win32.mod/.bmx/win32.bmx.release.linux.x86.h>
#include <pub.mod/xmmintrin.mod/.bmx/xmmintrin.bmx.release.linux.x86.h>
int _bb_main();
